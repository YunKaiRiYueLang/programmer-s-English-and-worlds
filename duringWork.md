2026/05/06
claw   爪子  钳子 。 lobster 才是龙虾。 openclaw 意思是开源的agent工具集合。翻译成龙虾可能是由于图标是龙虾吧。
hermes 希腊神话：赫尔墨斯（众神信使，商业、旅行、智慧之神）普通词义（小写 hermes 极少用）：信使、使者。 用在claw进阶版的名字上，用这个名字估计有吹牛逼的嫌疑
Ultrasonic Testing   超声检测 简称 UT
...
20260519
prefix  前缀 file prefix 文件前缀。有些raw文件以固定前缀加序号命名。
extent 范围   data extent 数据范围 读取raw图像时需要手动设置其数据信息的范围。
volume 体积，体 Calculate the center of the volume 计算体积中心
